...
(
    ...
    localparam PAD5 = log2ceil(64'hc0c0 - 64'hc0b0); 
    localparam PAD6 = log2ceil(64'hc100 - 64'hc0f0); 
    ...
    // ( 0xc040 .. 0xc050 )
    if ( {address[RG:PAD3],{PAD3{1'b0}}} == 16'hc040  && read_transaction  ) begin
    ...
    // ( 0xc0b0 .. 0xc0c0 )
    if ( {address[RG:PAD5],{PAD5{1'b0}}} == 16'hc0b0   ) begin
            src_channel = 8'b00100000;
            src_data[PKT_DEST_ID_H:PKT_DEST_ID_L] = 4;
    end

    // ( 0xc0f0 .. 0xc100 )
    if ( {address[RG:PAD6],{PAD6{1'b0}}} == 16'hc0f0   ) begin
